...
HD_PWD='D:/Vivado Workspace/Arty-A7/DSP_PROCESSOR/DSP_PROCESSOR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_PROCESSOR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP_PROCESSOR.tcl -notrace
