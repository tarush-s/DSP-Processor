...
HD_PWD='D:/Vivado Workspace/Arty-A7/DSP_PROCESSOR/DSP_PROCESSOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_PROCESSOR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP_PROCESSOR.tcl
